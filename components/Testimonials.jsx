        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-primary-color border border-color p-6 sm:p-8 card-hover relative"
            >
              {/* Quote Icon */}
              ...
              {/* Quote */}
              <blockquote className="text-base sm:text-lg text-color-1 mb-4 sm:mb-6 leading-relaxed italic">
                "{testimonial.quote}"
              </blockquote>
