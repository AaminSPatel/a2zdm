...
import { FiSearch, FiBarChart, FiTarget, FiDatabase, FiDollarSign ,FiActivity,
...
export const TechProvider = ({ children }) => {
  ...
  services: {
    ...
    description: "Optimize your website's foundation to ensure seamless crawling, indexing, and user experience.",
    longDescription: "Our technical SEO services focus on the foundation of your website's search performance. We conduct thorough audits, fix technical issues, and implement best practices to ensure search engines can easily crawl, understand, and index your content.",
    features: [
    ...
    pricing: {
      starter: { price: "₹12,000/month", features: ["Basic Technical Audit", "Core Issues Fix", "Monthly Report"] },
      professional: {
        price: "₹20,000/month",
  ...
  "link-earning": {
    ...
    heroImage: "/link.jpg",
    description: "Boost your authority with high-quality backlinks through ethical and strategic outreach.",
    longDescription: "Our link-earning services help you build authoritative backlinks that improve your domain authority and search rankings through white-hat techniques and strategic digital PR campaigns.",
    features: [
    ...
    process: [
      {
        ...
        description: "Creating a customized link-building plan based on your niche and goals."
      },
      {
        step: "2",
        title: "Outreach Preparation",
        description: "Identifying opportunities and preparing outreach materials."
      },
      {
        step: "3",
        title: "Link Acquisition",
        description: "Executing outreach campaigns to earn high-quality backlinks."
      },
      {
        step: "4",
        title: "Reporting",
        description: "Tracking progress and demonstrating ROI through detailed reports."
      }
    ],
    pricing: {
      starter: { price: "₹15,000/month", features: ["Basic Link Building", "5 Quality Links", "Monthly Report"] },
      professional: {
        price: "₹30,000/month",
        features: ["Strategic Link Building", "15 Quality Links", "Competitor Analysis", "Weekly Reports"]
      },
      enterprise: {
        price: "₹50,000/month",
        features: ["Comprehensive Campaign", "30+ Quality Links", "Digital PR Integration", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "B2B SaaS Company",
      challenge: "Low domain authority and stagnant rankings",
      solution: "Strategic link-building campaign focusing on industry publications and resource pages",
      results: [
    ...
    process: [
      {
        ...
        description: "Developing your unique value proposition and expert positioning."
      },
      {
        step: "2",
        title: "Media Targeting",
        description: "Identifying relevant publications and journalists in your industry."
      },
      {
        step: "3",
      ...
      },
      {
        step: "4",
        title: "Amplification",
        description: "Leveraging earned media across digital channels for maximum impact."
      }
    ],
    pricing: {
      starter: { price: "₹18,000/month", features: ["Basic Media Outreach", "3 Placements", "Monthly Report"] },
      professional: {
        price: "₹35,000/month",
        features: ["Comprehensive PR Campaign", "10 Placements", "Expert Positioning", "Weekly Strategy Calls"]
      },
      enterprise: {
        price: "₹60,000/month",
        features: ["Full-Scale Digital PR", "20+ Placements", "Crisis Management", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Healthcare Provider",
      challenge: "Lack of industry authority and media presence",
      solution: "Strategic PR campaign positioning executives as thought leaders through media placements",
      results: [
  ...
  "digital-analytics": {
    ...
    description: "Enhance visibility and drive conversions across your product and category pages.",
    longDescription: "Our eCommerce SEO services are specifically designed to help online stores rank higher for product and category searches, driving qualified traffic that converts into sales through comprehensive technical, on-page, and off-page optimizations.",
    features: [
    ...
    process: [
      {
        step: "1",
        title: "Technical Audit",
        description: "Comprehensive analysis of your eCommerce site's technical foundation."
      },
      {
        step: "2",
        title: "Keyword Strategy",
        description: "Developing search terms that match buyer intent at each funnel stage."
      },
      {
        step: "3",
        title: "Content Optimization",
        description: "Enhancing product pages and category structures for search visibility."
      },
      {
        step: "4",
        title: "Performance Tracking",
        description: "Monitoring traffic, rankings, and conversions to measure success."
      }
    ],
    pricing: {
      starter: { price: "₹20,000/month", features: ["Basic Product Optimization", "50 Products", "Monthly Report"] },
      professional: {
        price: "₹40,000/month",
        features: ["Complete Store Optimization", "200 Products", "Shopping Feed Setup", "Weekly Optimization"]
      },
      enterprise: {
        price: "₹75,000/month",
        features: ["Enterprise eCommerce SEO", "Unlimited Products", "Advanced Schema", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Fashion Retailer",
      challenge: "Low organic visibility for product searches",
      solution: "Comprehensive eCommerce SEO strategy including technical fixes and content optimization",
      results: [
  ...
  "local-seo": {
    ...
    description: "Capture more foot traffic and phone calls with precision local search optimization.",
    longDescription: "Our Local SEO services help businesses with physical locations dominate local search results through Google Business Profile optimization, local citations, review management, and geo-targeted content strategies that drive more local customers to your door.",
    features: [
    ...
    process: [
      {
        step: "1",
        title: "Local Audit",
        description: "Analyzing your current local search presence and identifying gaps."
      },
      {
        step: "2",
        title: "Profile Optimization",
        description: "Enhancing your Google Business Profile and other local listings."
      },
      {
        step: "3",
        title: "Citation Building",
        description: "Ensuring consistent NAP across local directories and platforms."
      },
      {
        step: "4",
        title: "Review Management",
        description: "Generating and responding to customer reviews strategically."
      }
    ],
    pricing: {
      starter: { price: "₹10,000/month", features: ["Basic GBP Optimization", "Citation Cleanup", "Monthly Report"] },
      professional: {
        price: "₹20,000/month",
        features: ["Complete Local SEO", "Review Management", "Local Content Strategy", "Weekly Optimization"]
      },
      enterprise: {
        price: "₹35,000/month",
        features: ["Multi-Location SEO", "Advanced Local Strategy", "Competitor Analysis", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Dental Clinic",
      challenge: "Low visibility in local searches for dental services",
      solution: "Comprehensive local SEO campaign including GBP optimization and review generation",
      results: [
        { metric: "Local Pack Rankings", improvement: "Top 3 for 15 keywords" },
  ...
  "home-services-seo": {
    ...
    description: "Target high-intent homeowners and generate more service leads via organic search.",
    longDescription: "Our Home Services SEO specializes in helping contractors, cleaners, and service providers rank for high-intent local searches through optimized service pages, trust-building content, and conversion-focused strategies that turn searches into service calls.",
    features: [
    ...
    process: [
      {
        ...
        description: "Identifying your most profitable services and search opportunities."
      },
      {
        step: "2",
        title: "Local Strategy",
        description: "Developing geo-targeted content for your service areas."
      },
      {
        step: "3",
        title: "Trust Building",
        description: "Creating content that establishes credibility and expertise."
      },
      {
        step: "4",
    ...
    pricing: {
      starter: { price: "₹14,000/month", features: ["Basic Service Optimization", "5 Service Pages", "Monthly Report"] },
      professional: {
        price: "₹28,000/month",
        features: ["Complete Home Services SEO", "15 Service Pages", "Review Management", "Weekly Optimization"]
      },
      enterprise: {
        price: "₹45,000/month",
        features: ["Advanced Strategy", "Unlimited Services", "24/7 Support", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Plumbing Company",
      challenge: "Low online visibility for emergency plumbing searches",
      solution: "Targeted home services SEO focusing on emergency pages and local optimization",
      results: [
  ...
  "cosmetics-seo": {
    ...
    description: "Rank higher in beauty-related searches by focusing on visual and product-driven strategies.",
    longDescription: "Our Cosmetics SEO services help beauty brands, salons, and skincare professionals stand out in a competitive market through visually-optimized content, ingredient-focused SEO, and beauty trend targeting that connects with your ideal customers.",
    features: [
    ...
    process: [
      {
        ...
        description: "Identifying trending searches in the cosmetics industry."
      },
      {
        step: "2",
        title: "Visual Optimization",
        description: "Enhancing images and videos for search and engagement."
      },
      {
        step: "3",
        title: "Ingredient SEO",
        description: "Creating content around skincare ingredients and benefits."
      },
      {
        step: "4",
        title: "Social Integration",
        description: "Leveraging visual platforms like Pinterest for SEO benefits."
      }
    ],
    pricing: {
      starter: { price: "₹16,000/month", features: ["Basic Beauty SEO", "5 Product Optimizations", "Monthly Report"] },
      professional: {
        price: "₹32,000/month",
        features: ["Complete Cosmetics SEO", "20 Product Optimizations", "Visual Content Strategy", "Weekly Updates"]
      },
      enterprise: {
        price: "₹55,000/month",
        features: ["Advanced Beauty Strategy", "Unlimited Products", "Influencer Integration", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Organic Skincare Brand",
      challenge: "Low visibility for natural skincare searches",
      solution: "Ingredient-focused SEO strategy combined with visual optimization",
      results: [
  ...
  "lawyers-seo": {
    ...
    description: "Acquire legal clients through trustworthy, practice-specific search optimization.",
    longDescription: "Our Lawyer SEO services help attorneys and law firms rank for high-value legal searches through authoritative content, local legal directory optimization, and trust signals that convert searchers into clients for your specific practice areas.",
    features: [
    ...
    process: [
      {
        ...
        description: "Identifying your most profitable legal services and search terms."
      },
      {
        step: "2",
        title: "Authority Building",
        description: "Creating content that establishes legal expertise and trust."
      },
      {
        step: "3",
        title: "Local Legal SEO",
        description: "Optimizing for local legal searches and directories."
      },
      {
        step: "4",
        title: "Conversion Optimization",
        description: "Improving your site to turn visitors into consultations."
      }
    ],
    pricing: {
      starter: { price: "₹17,000/month", features: ["Basic Legal SEO", "1 Practice Area", "Monthly Report"] },
      professional: {
        price: "₹35,000/month",
        features: ["Complete Law Firm SEO", "3 Practice Areas", "Legal Directory Management", "Weekly Updates"]
      },
      enterprise: {
        price: "₹60,000/month",
        features: ["Full-Service Legal Marketing", "Unlimited Practice Areas", "Premium Legal Directories", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Personal Injury Firm",
      challenge: "Low visibility for accident-related searches",
      solution: "Practice-area focused SEO with case study content and local optimization",
      results: [
  ...
  "restaurants-seo": {
    ...
    description: "Make your eatery the go-to choice with a powerful local and visual SEO strategy.",
    longDescription: "Our Restaurant SEO services help food establishments attract more diners through mouth-watering image optimization, local search domination, menu SEO, and review management that turns food searches into reservations and orders.",
    features: [
    ...
    process: [
      {
        ...
        description: "Identifying what food lovers are searching for in your area."
      },
      {
        step: "2",
        title: "Visual Content Creation",
        description: "Creating mouth-watering images optimized for search and social."
      },
      {
        step: "3",
        title: "Local Listings Optimization",
        description: "Ensuring your restaurant appears everywhere hungry customers look."
      },
      {
        step: "4",
        title: "Seasonal Promotion",
        description: "Capitalizing on holidays and events to drive more traffic."
      }
    ],
    pricing: {
      starter: { price: "₹9,000/month", features: ["Basic Restaurant SEO", "Menu Optimization", "Monthly Report"] },
      professional: {
        price: "₹18,000/month",
        features: ["Complete Restaurant SEO", "Visual Content Strategy", "Review Management", "Weekly Updates"]
      },
      enterprise: {
        price: "₹30,000/month",
        features: ["Premium Restaurant Marketing", "Influencer Partnerships", "Event Promotion", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Italian Restaurant",
      challenge: "Low visibility for local Italian food searches",
      solution: "Comprehensive restaurant SEO focusing on visual content and local optimization",
      results: [
  ...
  "retail-seo": {
    ...
    description: "Drive more foot traffic and online sales with retail-specific search optimization strategies.",
    longDescription: "Our Retail SEO services combine eCommerce and local SEO tactics to help brick-and-mortar and online retailers appear for high-intent product searches, seasonal trends, and local shopping queries that convert browsers into buyers.",
    features: [
    ...
    process: [
      {
        step: "1",
        title: "Retail Audit",
        description: "Comprehensive analysis of your current retail search presence"
      },
      {
        step: "2",
        title: "Product Optimization",
        description: "Enhancing product pages for both online and local search"
      },
      {
        step: "3",
    ...
    pricing: {
      starter: { price: "₹18,000/month", features: ["Basic Product Optimization", "Monthly Trend Report", "50 Products"] },
      professional: {
        price: "₹35,000/month",
        features: ["Complete Retail SEO", "Seasonal Campaigns", "Local Inventory Integration", "500 Products"]
      },
      enterprise: {
        price: "₹60,000/month",
        features: ["Enterprise Retail Solution", "Advanced Analytics", "Custom Integrations", "Unlimited Products"]
      }
    },
    caseStudy: {
      client: "National Apparel Chain",
      challenge: "Low online-to-offline conversion and poor seasonal visibility",
      solution: "Integrated retail SEO strategy with local inventory feeds and trend targeting",
      results: [
  ...
  "food-beverages-seo": {
    ...
    icon: "<FiCoffee className='w-8 h-8' />",
    heroImage: "/food.jpg",
    description: "Increase shelf presence and digital discoverability for your food and beverage products.",
    longDescription: "Specialized SEO for food manufacturers, beverage companies, and CPG brands to rank for ingredient searches, recipe terms, and product-related queries that influence purchase decisions at grocery and online retailers.",
    features: [
    ...
    pricing: {
      starter: { price: "₹20,000/month", features: ["Basic Product SEO", "10 Products", "Monthly Reports"] },
      professional: {
        price: "₹40,000/month",
        features: ["Complete F&B Strategy", "Recipe Content Development", "Retailer SEO", "50 Products"]
      },
      enterprise: {
        price: "₹75,000/month",
        features: ["Enterprise CPG Solution", "Advanced Schema", "Sales Correlation Analysis", "Unlimited Products"]
      }
    },
    caseStudy: {
      client: "Organic Snack Brand",
      challenge: "Low visibility for healthy snack searches",
      solution: "Ingredient-focused SEO with recipe content and retailer optimization",
      results: [
        { metric: "Organic Visibility", improvement: "+380%" },
        { metric: "Retailer Page Rankings", improvement: "Top 3 for 25+ products" },
  ...
  "jewelry-seo": {
    ...
    description: "Sparkle in search results with luxury-focused optimization for jewelry brands and retailers.",
    longDescription: "Specialized SEO services for jewelry stores, luxury brands, and independent designers focusing on high-value search terms, visual search optimization, and rich snippets that appeal to luxury shoppers and gift buyers.",
    features: [
    ...
    pricing: {
      starter: { price: "₹25,000/month", features: ["Basic Jewelry SEO", "10 Products", "Monthly Reports"] },
      professional: {
        price: "₹50,000/month",
        features: ["Complete Luxury SEO", "Visual Search Optimization", "Gift Content Strategy", "100 Products"]
      },
      enterprise: {
        price: "₹90,000/month",
        features: ["Enterprise Luxury Solution", "Advanced Visual SEO", "International Targeting", "Unlimited Products"]
      }
    },
    caseStudy: {
      client: "Diamond Jewelry Designer",
      challenge: "Poor visibility for custom jewelry searches",
      solution: "Luxury-focused SEO with visual search optimization and rich snippets",
      results: [
  ...
  "childcare-seo": {
    ...
    description: "Connect with parents through trusted, local search visibility for childcare services.",
    longDescription: "Specialized SEO for daycare centers, preschools, and childcare providers focusing on local search dominance, parent trust signals, and educational content that reassures and converts searching parents.",
    features: [
    ...
    pricing: {
      starter: { price: "₹15,000/month", features: ["Basic Childcare SEO", "Local Listings", "Monthly Reports"] },
      professional: {
        price: "₹30,000/month",
        features: ["Complete Childcare Strategy", "Review Management", "Educational Content", "Multi-Location"]
      },
      enterprise: {
        price: "₹55,000/month",
        features: ["Enterprise Solution", "Full Funnel Tracking", "Competitor Replacement", "Daily Monitoring"]
      }
    },
    caseStudy: {
      client: "Montessori Preschool",
      challenge: "Low visibility for local preschool searches",
      solution: "Trust-focused SEO with educational content and local directory dominance",
      results: [
        { metric: "Parent Inquiries", improvement: "+380%" },
        { metric: "Local Pack Rankings", improvement: "Top 3 for 12 keywords" },
...
/*  {
 ...
 //digital Analytics
  ...
  "ga4-analytics": {
    ...
    icon: "<FiBarChart2 className='w-8 h-8' />",
    heroImage: "/ga4.jpg",
    description: "Master the new analytics standard with comprehensive GA4 implementation and insights.",
    longDescription: "Our GA4 services include complete migration from Universal Analytics, custom implementation, event tracking setup, and ongoing analysis to help you navigate the new analytics paradigm and extract meaningful insights from your data.",
    features: [
    ...
    pricing: {
      starter: { price: "₹25,000", features: ["Basic GA4 Setup", "Standard Event Tracking", "Implementation Report"] },
      professional: {
        price: "₹50,000",
        features: ["Complete GA4 Migration", "Custom Event Tracking", "Enhanced Measurement", "Basic Dashboard"]
      },
      enterprise: {
        price: "₹90,000",
        features: ["Enterprise Implementation", "Advanced Configurations", "Custom Connectors", "Training Sessions"]
      }
    },
    caseStudy: {
      client: "Ecommerce Platform",
      challenge: "Losing visibility with Universal Analytics sunset",
      solution: "Comprehensive GA4 migration with custom eCommerce tracking",
      results: [
        { metric: "Tracked Conversions", improvement: "+40% more events" },
        { metric: "Attribution Accuracy", improvement: "+65% better insights" },
  ...
  "google-tag-manager": {
    ...
    heroImage: "/gtm.jpg",
    description: "Take control of your tracking and marketing tags without constant developer reliance.",
    longDescription: "Our GTM services help you implement, manage, and optimize your tag management system to streamline tracking implementations, improve site performance, and maintain better control over your marketing technologies.",
    features: [
    ...
    pricing: {
      starter: { price: "₹20,000", features: ["Basic GTM Setup", "Standard Tags", "Implementation Report"] },
      professional: {
        price: "₹40,000",
        features: ["Complete GTM Implementation", "Custom Data Layer", "Advanced Triggers", "Basic Training"]
      },
      enterprise: {
        price: "₹75,000",
        features: ["Enterprise Solution", "Complex Configurations", "Custom JavaScript", "Ongoing Support"]
      }
    },
    caseStudy: {
  ...
  "piwikpro-analytics": {
    ...
    description: "Privacy-compliant analytics alternative with enterprise-grade features and data ownership.",
    longDescription: "Implementation and management of Piwik PRO Analytics Suite for organizations needing GDPR-compliant analytics with full data ownership, combining powerful insights with strict privacy compliance.",
    features: [
    ...
    pricing: {
      starter: { price: "₹30,000", features: ["Basic Implementation", "Standard Configuration", "Initial Training"] },
      professional: {
        price: "₹60,000",
        features: ["Complete Setup", "Custom Dimensions", "Basic Integrations", "Extended Training"]
      },
      enterprise: {
        price: "₹120,000",
        features: ["Enterprise Deployment", "Advanced Configuration", "Custom Development", "Ongoing Support"]
      }
    },
    caseStudy: {
      client: "European Healthcare Provider",
      challenge: "Need for GDPR-compliant analytics without US data transfer",
      solution: "Piwik PRO implementation with strict data governance",
      results: [
        { metric: "Compliance Level", improvement: "100% GDPR aligned" },
        { metric: "Data Ownership", improvement: "Full control achieved" },
  ...
  "performance-marketing": {
    ...
    description: "Data-driven marketing strategies focused on measurable ROI and conversion optimization.",
    longDescription: "Full-funnel performance marketing services combining paid media, conversion rate optimization, and analytics to drive qualified traffic that converts, with transparent reporting and continuous optimization.",
    features: [
    ...
    pricing: {
      starter: { price: "₹30,000/month", features: ["Basic Campaign Management", "2 Channels", "Monthly Reporting"] },
      professional: {
        price: "₹75,000/month",
        features: ["Complete Performance Marketing", "5 Channels", "Conversion Optimization", "Weekly Optimization"]
      },
      enterprise: {
        price: "₹150,000/month",
        features: ["Enterprise Solution", "Full Funnel Management", "Advanced Attribution", "Dedicated Team"]
      }
    },
    caseStudy: {
  ...
  "cookie-consent-management": {
    ...
    description: "Achieve GDPR and global privacy compliance with enterprise-grade consent management.",
    longDescription: "Implementation of cookie consent solutions that adapt to regional privacy laws, providing compliance for GDPR, CCPA, and other global regulations while maintaining marketing capabilities.",
    features: [
    ...
    pricing: {
      starter: { price: "₹25,000", features: ["Basic Implementation", "Standard Banner", "Cookie Audit"] },
      professional: {
        price: "₹50,000",
        features: ["Complete Solution", "Custom Branding", "Region Rules", "Basic Reporting"]
      },
      enterprise: {
        price: "₹100,000",
        features: ["Enterprise Platform", "Advanced Rules", "Consent Analytics", "Ongoing Updates"]
      }
    },
    caseStudy: {
      client: "Multinational Retailer",
      challenge: "Non-compliant tracking across 15 countries",
      solution: "Enterprise consent management with region-specific rules",
      results: [
  ...
  "tag-monitoring": {
    ...
    heroImage: "/tag.jpg",
    description: "Continuous monitoring of your tracking technologies to ensure data accuracy and site performance.",
    longDescription: "Proactive monitoring and alerting for your marketing tags, pixels, and tracking scripts to prevent data loss, identify broken implementations, and maintain optimal website performance.",
    features: [
      "24/7 tag monitoring",
      "Real-time alerts",
    ...
    pricing: {
      starter: { price: "₹15,000/month", features: ["Basic Monitoring", "10 Tags", "Email Alerts"] },
      professional: {
        price: "₹35,000/month",
        features: ["Advanced Monitoring", "Unlimited Tags", "Slack/SMS Alerts", "Performance Analysis"]
      },
      enterprise: {
        price: "₹65,000/month",
        features: ["Enterprise Monitoring", "Custom Rules", "Historical Analysis", "Dedicated Support"]
      }
    },
    caseStudy: {
      ...
      results: [
        { metric: "Tracking Downtime", improvement: "-100% (zero incidents)" },
...
//Predictive Analytics
  ...
  "customer-segmentation": {
    ...
    description: "Divide your customer base into strategic groups for targeted marketing, personalized experiences, and efficient resource allocation.",
    ...
    caseStudy: {
      ...
      challenge: "Generic marketing leading to 22% email unsubscribe rates",
      solution: "12 dynamic segments based on style preferences + purchase cadence",
      results: [
  ...
  "sales-forecasting": {
    ...
    icon: "<FiTrendingUp className='w-8 h-8' />",
    heroImage: "/sales.jpg",
    description: "Predict future revenue with 90%+ accuracy using AI-driven models that factor in market trends, seasonality, and leading indicators.",
    longDescription: "Our sales forecasting solutions combine time-series analysis, machine learning (Prophet, ARIMA), and economic indicators to generate accurate, granular predictions. We account for pipeline health, market shifts, and organizational factors to reduce forecast error by 40-60% compared to spreadsheet methods.",
    features: [
    ...
    caseStudy: {
      ...
      solution: "ML model incorporating weather, repair trends, and economic data",
      results: [
        { metric: "Forecast Accuracy", improvement: "92% (from 65%)" },
        { metric: "Inventory Costs", improvement: "-₹5.2M annual savings" },
...
//Business Intelligence
  ...
  "looker-studio": {
    ...
    description: "Transform your data into insightful, interactive dashboards with Google's powerful visualization tool.",
    longDescription: "Our Looker Studio (formerly Google Data Studio) services help you create custom, visually compelling dashboards that connect to hundreds of data sources, enabling better decision-making through accessible data storytelling and real-time reporting.",
    features: [
      "Custom dashboard development",
    ...
    caseStudy: {
      ...
      challenge: "Disparate reports across 8 platforms causing decision delays",
      solution: "Unified Looker Studio dashboard blending Google Analytics, Shopify, and ad platform data",
      results: [
        { metric: "Reporting Time", improvement: "-80%" },
        { metric: "Data Accuracy", improvement: "100% consistency" },
        { metric: "Meeting Efficiency", improvement: "+65% faster decisions" }
      ]
    }
  },
  ...
  "bigquery": {
    ...
    description: "Unlock the power of serverless, petabyte-scale analytics with Google's enterprise data warehouse.",
    longDescription: "Our BigQuery services include architecture design, implementation, and optimization of Google's cloud data warehouse solution, enabling SQL-based analysis of massive datasets with blazing-fast performance and seamless integration with the Google Cloud ecosystem.",
    features: [
    ...
    caseStudy: {
      ...
      challenge: "Unable to analyze 2+ years of call detail records (20TB+)",
      solution: "BigQuery implementation with partitioned tables and optimized queries",
      results: [
        { metric: "Query Speed", improvement: "100x faster" },
        { metric: "Storage Costs", improvement: "-70%" },
        { metric: "Analytics Capability", improvement: "Enabled advanced churn prediction" }
      ]
    }
  },
  ...
  "power-bi": {
    ...
    description: "Microsoft's leading BI platform for enterprise-grade data modeling, visualization, and embedded analytics.",
    longDescription: "End-to-end Power BI services including data modeling, DAX formula development, premium workspace setup, and embedded analytics solutions that transform your raw data into actionable business insights with Microsoft's powerful BI ecosystem.",
    features: [
    ...
    caseStudy: {
      ...
      solution: "Centralized Power BI solution with 50+ interactive dashboards",
      results: [
        { metric: "Report Creation Time", improvement: "-90%" },
        { metric: "Data Consistency", improvement: "Single source of truth" },
...
//Pay Per Click Management
  ...
  "performance-measurement": {
    ...
    description: "Advanced frameworks to quantify and optimize marketing effectiveness across channels and tactics.",
    longDescription: "Implementation of sophisticated measurement frameworks including MMM (Media Mix Modeling), MTA (Multi-Touch Attribution), incrementality testing, and unified analytics to properly assess marketing ROI and optimize budget allocation.",
    features: [
    ...
    process: [
      ...
      },
      {
        ...
        description: "Translating results into actionable recommendations"
      }
    ],
    pricing: {
      starter: { 
    ...
    caseStudy: {
      ...
      results: [
        ...
        { metric: "ROI Clarity", improvement: "Channel-level visibility" }
      ]
    }
  },
