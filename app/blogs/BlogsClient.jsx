...
const BlogsClient = ({ blogs, categories, tags }) => {
    ...
    return (
      <div className="min-h-screen bg-primary-color flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4 text-color-1">No Blog Posts Found</h1>
          <p className="text-color-2 mb-6">Please check back later for new content.</p>
