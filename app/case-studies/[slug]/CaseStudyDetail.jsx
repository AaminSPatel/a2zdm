// app/case-studies/[slug]/CaseStudyDetail.js
"use client";
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://yourdomain.com/case-studies/${caseStudy.slug}`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": `https://yourdomain.com/case-studies/${caseStudy.slug}`,
