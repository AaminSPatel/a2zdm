...
import { FiArrowLeft, FiArrowRight, FiTarget, FiUsers, FiTrendingUp, FiAward } from "react-icons/fi"
  ...
  const teamMembers = [
    {
      ...
      experience: "8+ years",
      description: "Visionary leader with expertise in technical SEO and business growth strategies.",
      initial: "AS",
    },
    {
      name: "Priya Patel",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-color-2 max-w-3xl mx-auto">
                We're a team of digital marketing experts passionate about helping businesses unlock their growth
                potential through data-driven strategies and cutting-edge technology.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-base sm:text-lg text-color-2 mb-4 sm:mb-6 leading-relaxed">
                  At A2ZDM, we believe that every business deserves to thrive in the digital landscape. Our mission is
                  to democratize access to advanced digital marketing strategies by combining powerful SEO,
                  sophisticated analytics, and performance marketing techniques.
                </p>
                <p className="text-base sm:text-lg text-color-2 leading-relaxed">
                  We don't just implement tactics—we build comprehensive growth systems that scale with your business,
                  ensuring sustainable success in an ever-evolving digital world.
                </p>
              </motion.div>
                  ...
                  <div className="h-full flex flex-col justify-between">
                    <div className="space-y-3 sm:space-y-4">
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <span className="text-color-1 text-sm sm:text-base">Data-Driven Strategies</span>
                      </div>
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        <div className="w-3 sm:w-4 h-3 sm:h-4 bg-blue-400"></div>
                        <span className="text-color-1 text-sm sm:text-base">Measurable Results</span>
                      </div>
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        <div className="w-3 sm:w-4 h-3 sm:h-4 bg-purple-400"></div>
                        <span className="text-color-1 text-sm sm:text-base">Sustainable Growth</span>
                      </div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl sm:text-4xl font-bold accent-cyan mb-2">5+</div>
                      <div className="text-color-2 text-sm sm:text-base">Years of Excellence</div>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <section className="py-16 sm:py-20 bg-secondary-color">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-color-2 max-w-3xl mx-auto">
                Our diverse team of experts brings together years of experience in SEO, analytics, and performance
                marketing
              </p>
            </motion.div>
                  ...
                  {teamMembers.map((_, index) => (
                    <button
                      ...
                      className={`w-2 sm:w-3 h-2 sm:h-3 transition-colors ${
                        index === currentTeamMember ? "bg-accent-cyan" : "bg-gray-600"
                      }`}
                    />
                  ))}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              {values.map((value, index) => (
                ...
                >
                  ...
                  <p className="text-color-2 leading-relaxed text-sm sm:text-base">{value.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-color-2 mb-6 sm:mb-8">
                Let's discuss how our expertise can help accelerate your business growth through smarter digital
